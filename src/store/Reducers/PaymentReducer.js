...
export const get_seller_payemt_details = createAsyncThunk(
    ...
    async (sellerId, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/payment/seller-payment-details/${sellerId}`, config)
...
export const send_withdrowal_request = createAsyncThunk(
    ...
    async (info, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.post(`${api_url}/payment/withdrowal-request`, info, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_payment_request = createAsyncThunk(
    ...
    async (_, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/payment/request`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const confirm_payment_request = createAsyncThunk(
    ...
    async (paymentId, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.post(`${api_url}/payment/request-confirm`, { paymentId }, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
