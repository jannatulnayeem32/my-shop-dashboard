...
export const get_admin_orders = createAsyncThunk(
    ...
    async ({ parPage, page, searchValue }, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/admin/orders?page=${page}&searchValue=${searchValue}&parPage=${parPage}`, config)
...
export const get_seller_orders = createAsyncThunk(
    ...
    async ({ parPage, page, searchValue, sellerId }, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/seller/orders/${sellerId}?page=${page}&searchValue=${searchValue}&parPage=${parPage}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_admin_order = createAsyncThunk(
    ...
    async (orderId, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/admin/order/${orderId}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_seller_order = createAsyncThunk(
    ...
    async (orderId, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/seller/order/${orderId}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const admin_order_status_update = createAsyncThunk(
    ...
    async ({ orderId, info }, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.put(`${api_url}/admin/order-status/update/${orderId}`, info, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const seller_order_status_update = createAsyncThunk(
    ...
    async ({ orderId, info }, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.put(`${api_url}/seller/order-status/update/${orderId}`, info, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
