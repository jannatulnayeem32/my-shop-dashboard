...
export const get_customers = createAsyncThunk(
    ...
    async (sellerId, { rejectWithValue, fulfillWithValue, getState }) => {
        ...
        try {
            ...
            const { data } = await axios.get(`${api_url}/chat/seller/get-customers/${sellerId}`, config)
...
export const get_customer_message = createAsyncThunk(
    ...
    async (customerId, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/chat/seller/get-customer-message/${customerId}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const send_message = createAsyncThunk(
    ...
    async (info, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.post(`${api_url}/chat/seller/send-message-to-customer`, info, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_sellers = createAsyncThunk(
    ...
    async (_, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/chat/admin/get-sellers`, config)
            console.log(data)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
...
export const send_message_seller_admin = createAsyncThunk(
    ...
    async (info, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.post(`${api_url}/chat/message-send-seller-admin`, info, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_admin_message = createAsyncThunk(
    ...
    async (receverId, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/chat/get-admin-messages/${receverId}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_seller_message = createAsyncThunk(
    ...
    async (receverId, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/chat/get-seller-messages`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
