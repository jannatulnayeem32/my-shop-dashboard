...
export const get_seller_request = createAsyncThunk(
    ...
    async ({ parPage, page, searchValue }, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/request-seller-get?page=${page}&&searchValue=${searchValue}&&parPage=${parPage}`, config)
...
export const get_seller = createAsyncThunk(
    ...
    async (sellerId, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/get-seller/${sellerId}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const seller_status_update = createAsyncThunk(
    ...
    async (info, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.post(`${api_url}/seller-status-update`, info, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_active_sellers = createAsyncThunk(
    ...
    async ({ parPage, page, searchValue }, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/get-sellers?page=${page}&&searchValue=${searchValue}&&parPage=${parPage}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_deactive_sellers = createAsyncThunk(
    ...
    async ({ parPage, page, searchValue }, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.get(`${api_url}/get-deactive-sellers?page=${page}&&searchValue=${searchValue}&&parPage=${parPage}`, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const create_stripe_connect_account = createAsyncThunk(
    ...
    async ({ }, { getState }) => {
        try {
            ...
            const { data: { url } } = await axios.get(`${api_url}/payment/create-stripe-connect-account`, config)
...
export const active_stripe_connect_account = createAsyncThunk(
    ...
    async (activeCode, { rejectWithValue, fulfillWithValue, getState }) => {
        try {
            ...
            const { data } = await axios.put(`${api_url}/payment/active-stripe-connect-account/${activeCode}`, {}, config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
