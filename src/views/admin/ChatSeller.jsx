...
import { socket, app_url } from '../../utils/utils'
                        ...
                        <div className='flex justify-between items-center'>
                            {
                                sellerId && <div className='flex justify-start items-center gap-3'>
                                    <div className='relative'>
                                        <img className='w-[42px] h-[42px] border-green-500 border-2 max-w-[38px] p-[2px] rounded-full' src={`${app_url}/images/admin.jpg`} alt="" />
